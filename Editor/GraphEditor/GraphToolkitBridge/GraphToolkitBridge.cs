		...
		public static void ApplyWindowCustomizations()
		{
			...
			foreach (var window in Resources.FindObjectsOfTypeAll<GraphViewEditorWindowImp>())
			{
				...
				LoadAndApplyStyleSheet(ref s_WindowStyleSheet,
					"Packages/com.api-haus.fastnoise2/Editor/GraphEditor/GraphToolkitBridge/StyleSheets/FN2Window.uss",
					window.rootVisualElement);

				// Inject Terrain Background USS
				LoadAndApplyStyleSheet(ref s_TerrainBackgroundStyleSheet,
					"Packages/com.api-haus.fastnoise2/Editor/GraphEditor/GraphToolkitBridge/StyleSheets/FN2TerrainBackground.uss",
					window.rootVisualElement);
				...
				LoadAndApplyStyleSheet(ref s_MainPreviewStyleSheet,
					"Packages/com.api-haus.fastnoise2/Editor/GraphEditor/GraphToolkitBridge/StyleSheets/FN2MainPreview.uss",
					window.rootVisualElement);

				// Inject Preview Widget USS
				LoadAndApplyStyleSheet(ref s_PreviewWidgetStyleSheet,
					"Packages/com.api-haus.fastnoise2/Editor/GraphEditor/GraphToolkitBridge/StyleSheets/FN2PreviewWidget.uss",
					window.rootVisualElement);
